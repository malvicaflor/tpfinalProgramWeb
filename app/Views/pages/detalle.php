...
<section class="detalle-producto">
    ...
    <div class="carrusel">
        <?php
            ...
            if (!empty($producto['imagenes'])) {
                ...
                // Si json_decode falla (string simple), convertirlo en array
                if (!is_array($imagenes)) {
                    $imagenes = [$producto['imagenes']];
                }
            } else {
                $imagenes = ['default.jpg']; // imagen por defecto
            }
        ?>
    ...
    <div class="detalle-texto">
        ...
        <?php if (!empty($tallesDisponibles) && is_array($tallesDisponibles)): ?>
            <div class="selector-talle">
                <label for="talle">Talle:</label>
                <select id="talle">
                    <?php foreach ($tallesDisponibles as $t): ?>
                        <option value="<?= esc($t['talle']) ?>">
                            <?= esc($t['talle']) ?> (<?= esc($t['cantidad']) ?> disponibles)
                        </option>
                    <?php endforeach; ?>
                </select>
            </div>
